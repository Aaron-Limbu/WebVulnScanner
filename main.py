...
class Dash(ctk.CTk): 
    ...
    def show_sidebar(self): 
        ...
        home_btn = ctk.CTkButton(self.sidebar,text="Home",font=("Arial",15),corner_radius=30,hover_color="#1e1e1e",command=self.show_content,height=30,width=200)
        home_btn.grid(row=1,column=0,padx=10,pady=10)
        UH_btn = ctk.CTkButton(self.sidebar,text="Programmes",font=("Arial",15),corner_radius=30,hover_color="#1e1e1e",command=self.show_programmes,height=30,width=200)
        UH_btn.grid(row=2,column=0,padx=10,pady=10)
        tools_btn = ctk.CTkButton(self.sidebar,text="Tools",font=("Arial",14),corner_radius=30,hover_color="#1e1e1e",height=30,width=200 )
        ...
        log_btn = ctk.CTkButton(self.sidebar,text="URL Log",font=("Arial",15),corner_radius=30,hover_color="#1e1e1e",height=30,width=200)
        log_btn.grid(row=5,column=0,padx=10,pady=10)
        log_btn2 = ctk.CTkButton(self.sidebar,text="Export Log",font=("Arial",15),corner_radius=30,hover_color="#1e1e1e",height=30,width=200)
        ...
        toggl_btn = ctk.CTkButton(self.sidebar,text="Log out",font=("Arial",15),corner_radius=30,hover_color="#1e1e1e",height=30,width=200)
