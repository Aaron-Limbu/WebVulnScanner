...
class Dash(ctk.CTk): 
    ...
    def form(self,n):       
        if n.lower() in ["banner grabber"]:
            ...
            submit_button = ctk.CTkButton(self.box_frame, text="Start Scan",
                                          ...
                                          command=lambda: self.scan(self.ip_entry.get(), self.port_entry.get(),tool="banner_grabber")) #command=self.start_banner_grabber)
            ...
            self.log_label = ctk.CTkLabel(log_frame, text="Script Log", font=("Arial", 20, "bold"), wraplength=450)
            self.log_label.grid(row=0, columnspan=2, padx=10, pady=(20, 5), sticky="w")
        ...
        if n.lower() in ["directory enumeration"]: 
            ...
            submit_button = ctk.CTkButton(self.box_frame, text="Start Scan",font=("arial",20,"bold"),width=400, height=40)  #command=self.start_banner_grabber)
        ...
        if n.lower() in ["web scraper"]: 
            ...
            submit_button = ctk.CTkButton(self.box_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
            submit_button.grid(row=3, columnspan=2, pady=15)
            log_frame = ctk.CTkScrollableFrame(self.content_frame, width=500)
            log_frame.grid(row=4,columnspan=2,pady=(20,5))
            log_frame.columnconfigure(0,weight=1)
        ...
        if n.lower() in ["command injection"]:
            ...
            domain_label.grid(row=2,column=0,padx=10,pady=(40,20),sticky="e")
            domain_entry = ctk.CTkEntry(self.content_frame,width=300,font=("arial",16))
            domain_entry.grid(row=2,column=1,padx=10,pady=(40,20),sticky="w")
            ...
            self.param_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            ...
            self.header_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            ...
            self.cookie_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            ...
            self.delay_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            ...
            self.wordlist_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            ...
            self.threads_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            ...
            self.filter_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
        ...
        if n.lower() in ["csrf scanning"]:
            ...
            domain_entry = ctk.CTkEntry(self.content_frame,width=300,font=("arial",16))
            domain_entry.grid(row=2,column=1,padx=10,pady=(40,20),sticky="w")
            cookie_label = ctk.CTkLabel(self.content_frame,text="Enter Cookie : ",font=("arial",16))
            cookie_label.grid(row=3,column=0,padx=10,pady=(40,20),sticky="e")
            cookie_entry = ctk.CTkEntry(self.content_frame,width=300,font=("arial",16))
            cookie_entry.grid(row=3,column=1,padx=10,pady=(40,20),sticky="w")
            u_agent = ctk.CTkLabel(self.content_frame,text="Enter user agent : ",font=("arial",16,"bold"))
            u_agent.grid(row=4,column=0,padx=10,pady=(40,20),sticky="e")
            u_entery = ctk.CTkEntry(self.content_frame,width=300,font=("arial",16))
            u_entery.grid(row=4,column=1,padx=10,pady=(40,20),sticky="w")
            submit_button = ctk.CTkButton(self.content_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
            submit_button.grid(row=5, columnspan=2, pady=15)
            log_frame = ctk.CTkScrollableFrame(self.content_frame, width=500)
            log_frame.grid(row=6,columnspan=2,pady=(20,5))
        ...
        if n.lower() in ["idor scan"]:
            ...
            url_label = ctk.CTkLabel(self.content_frame, text="Target URL:", font=("arial", 16, "bold"))
            url_label.grid(row=2, column=0, padx=10, pady=(10, 10), sticky="e")
            url_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            url_entry.grid(row=2, column=1, padx=10, pady=(10, 10), sticky="w")
            param_label = ctk.CTkLabel(self.content_frame, text="Parameter:", font=("arial", 16, "bold"))
            param_label.grid(row=3, column=0, padx=10, pady=(10, 10), sticky="e")
            param_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            param_entry.grid(row=3, column=1, padx=10, pady=(10, 10), sticky="w")
            start_label = ctk.CTkLabel(self.content_frame, text="Start ID:", font=("arial", 16, "bold"))
            start_label.grid(row=4, column=0, padx=10, pady=(10, 10), sticky="e")
            start_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            start_entry.grid(row=4, column=1, padx=10, pady=(10, 10), sticky="w")
            end_label = ctk.CTkLabel(self.content_frame, text="End ID:", font=("arial", 16, "bold"))
            end_label.grid(row=5, column=0, padx=10, pady=(10, 10), sticky="e")
            end_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            end_entry.grid(row=5, column=1, padx=10, pady=(10, 10), sticky="w")
            method_label = ctk.CTkLabel(self.content_frame, text="HTTP Method:", font=("arial", 16, "bold"))
            method_label.grid(row=6, column=0, padx=10, pady=(10, 10), sticky="e")
            method_dropdown = ctk.CTkOptionMenu(self.content_frame, values=["GET", "POST"])
            method_dropdown.grid(row=6, column=1, padx=10, pady=(10, 10), sticky="w")
            method_dropdown.set("GET") 
            header_label = ctk.CTkLabel(self.content_frame, text="Header:", font=("arial", 16, "bold"))
            header_label.grid(row=7, column=0, padx=10, pady=(10, 10), sticky="e")
            header_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            header_entry.grid(row=7, column=1, padx=10, pady=(10, 10), sticky="w")
            cookie_label = ctk.CTkLabel(self.content_frame, text="Cookie:", font=("arial", 16, "bold"))
            cookie_label.grid(row=8, column=0, padx=10, pady=(10, 10), sticky="e")
            cookie_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            cookie_entry.grid(row=8, column=1, padx=10, pady=(10, 10), sticky="w")
            submit_button = ctk.CTkButton(self.content_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
        ...
        if n.lower() in ["lfi scan"]:
            ...
            url_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            url_entry.grid(row=2, column=1, padx=10, pady=(10, 10), sticky="w")
            param_label = ctk.CTkLabel(self.content_frame, text="Vulnerable Parameter:", font=("arial", 16, "bold"))
            param_label.grid(row=3, column=0, padx=10, pady=(10, 10), sticky="e")
            param_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            param_entry.grid(row=3, column=1, padx=10, pady=(10, 10), sticky="w")
            encoding_label = ctk.CTkLabel(self.content_frame, text="Encoding Technique:", font=("arial", 16, "bold"))
            encoding_label.grid(row=4, column=0, padx=10, pady=(10, 10), sticky="e")
            encoding_dropdown = ctk.CTkOptionMenu(self.content_frame, values=["base64", "double_url", "single_url"])
            encoding_dropdown.grid(row=4, column=1, padx=10, pady=(10, 10), sticky="w")
            encoding_dropdown.set("base64") 
            cookies_label = ctk.CTkLabel(self.content_frame, text="Session Cookies:", font=("arial", 16, "bold"))
            cookies_label.grid(row=5, column=0, padx=10, pady=(10, 10), sticky="e")
            cookies_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            cookies_entry.grid(row=5, column=1, padx=10, pady=(10, 10), sticky="w")
            headers_label = ctk.CTkLabel(self.content_frame, text="Custom Headers:", font=("arial", 16, "bold"))
            headers_label.grid(row=6, column=0, padx=10, pady=(10, 10), sticky="e")
            headers_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            headers_entry.grid(row=6, column=1, padx=10, pady=(10, 10), sticky="w")
            threads_label = ctk.CTkLabel(self.content_frame, text="Number of Threads:", font=("arial", 16, "bold"))
            threads_label.grid(row=7, column=0, padx=10, pady=(10, 10), sticky="e")
            threads_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            threads_entry.grid(row=7, column=1, padx=10, pady=(10, 10), sticky="w")
            submit_button = ctk.CTkButton(self.content_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
            submit_button.grid(row=8, columnspan=2, pady=15)
            log_frame = ctk.CTkScrollableFrame(self.content_frame, width=500)
            log_frame.grid(row=9,columnspan=2,pady=(20,5))
            log_frame.columnconfigure(0,weight=1)
            log_label = ctk.CTkLabel(log_frame,text="Script Log",font=("arial",20,"bold"))
            log_label.grid(row=0,columnspan=2,pady=(20,5))
        ...
        if n.lower() in ["nmap scan"]:
            ...
            ip_label = ctk.CTkLabel(self.content_frame, text="IP Address:", font=("arial", 16, "bold"))
            ip_label.grid(row=2, column=0, padx=10, pady=(10, 10), sticky="e")
            ip_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            ip_entry.grid(row=2, column=1, padx=10, pady=(10, 10), sticky="w")
            ports_label = ctk.CTkLabel(self.content_frame, text="Ports (e.g., 20-80):", font=("arial", 16, "bold"))
            ports_label.grid(row=3, column=0, padx=10, pady=(10, 10), sticky="e")
            ports_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            ports_entry.insert(0, "20-80") 
            ports_entry.grid(row=3, column=1, padx=10, pady=(10, 10), sticky="w")
            args_label = ctk.CTkLabel(self.content_frame, text="Scan Arguments:", font=("arial", 16, "bold"))
            args_label.grid(row=4, column=0, padx=10, pady=(10, 10), sticky="e")
            args_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            args_entry.insert(0, "-sS -sV") 
            args_entry.grid(row=4, column=1, padx=10, pady=(10, 10), sticky="w")
            script_label = ctk.CTkLabel(self.content_frame, text="Nmap Script (Optional):", font=("arial", 16, "bold"))
            script_label.grid(row=5, column=0, padx=10, pady=(10, 10), sticky="e")
            script_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            script_entry.grid(row=5, column=1, padx=10, pady=(10, 10), sticky="w")
            submit_button = ctk.CTkButton(self.content_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
        ...
        if n.lower() in ["sql injection(error based)"]:
            ...
            url_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            url_entry.grid(row=2, column=1, padx=10, pady=(10, 10), sticky="w")
            method_label = ctk.CTkLabel(self.content_frame, text="Method:", font=("arial", 16, "bold"))
            method_label.grid(row=3, column=0, padx=10, pady=(10, 10), sticky="e")
            method_dropdown = ctk.CTkOptionMenu(self.content_frame, values=["f (Form)", "q (Query Parameter)"])
            method_dropdown.grid(row=3, column=1, padx=10, pady=(10, 10), sticky="w")
            ...
            user_agent_label = ctk.CTkLabel(self.content_frame, text="User-Agent:", font=("arial", 16, "bold"))
            user_agent_label.grid(row=5, column=0, padx=10, pady=(10, 10), sticky="e")
            user_agent_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            user_agent_entry.grid(row=5, column=1, padx=10, pady=(10, 10), sticky="w")
            submit_button = ctk.CTkButton(self.content_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
            submit_button.grid(row=6, columnspan=2, pady=15)
            log_frame = ctk.CTkScrollableFrame(self.content_frame, width=500)
            log_frame.grid(row=7,columnspan=2,pady=(20,5))
        ...
        if n.lower() in ["ssrf scan"]:
            ...
            cookie_label = ctk.CTkLabel(self.content_frame, text="Session Cookie:", font=("arial", 16, "bold"))
            cookie_label.grid(row=6, column=0, padx=10, pady=(10, 10), sticky="e")
            cookie_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            cookie_entry.grid(row=6, column=1, padx=10, pady=(10, 10), sticky="w")
            delay_label = ctk.CTkLabel(self.content_frame, text="Delay (seconds):", font=("arial", 16, "bold"))
            delay_label.grid(row=7, column=0, padx=10, pady=(10, 10), sticky="e")
            delay_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            delay_entry.insert(0, "0")  # Default value
            delay_entry.grid(row=7, column=1, padx=10, pady=(10, 10), sticky="w")
            dns_var = ctk.BooleanVar()
            dns_checkbox = ctk.CTkCheckBox(self.content_frame, text="Test for DNS Rebinding", variable=dns_var)
            dns_checkbox.grid(row=9, column=1, padx=10, pady=(10, 10), sticky="w")
            time_var = ctk.BooleanVar()
            time_checkbox = ctk.CTkCheckBox(self.content_frame, text="Test for Time-based SSRF", variable=time_var)
            time_checkbox.grid(row=10, column=1, padx=10, pady=(10, 10), sticky="w")
            wordlist_label = ctk.CTkLabel(self.content_frame, text="Payload Wordlist:", font=("arial", 16, "bold"))
            wordlist_label.grid(row=11, column=0, padx=10, pady=(10, 10), sticky="e")
            wordlist_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            wordlist_entry.grid(row=11, column=1, padx=10, pady=(10, 10), sticky="w")
            submit_button = ctk.CTkButton(self.content_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
            submit_button.grid(row=12, columnspan=2, pady=15)
            log_frame = ctk.CTkScrollableFrame(self.content_frame, width=500)
            log_frame.grid(row=13,columnspan=2,pady=(20,5))
            log_frame.columnconfigure(0,weight=1)
            log_label = ctk.CTkLabel(log_frame,text="Script Log",font=("arial",20,"bold"))
            log_label.grid(row=0,columnspan=2,pady=(20,5))
        ...
        if n.lower() in ["xee scan"]:
            ...
            header_label = ctk.CTkLabel(self.content_frame, text="Custom Headers:", font=("arial", 16, "bold"))
            header_label.grid(row=4, column=0, padx=10, pady=(10, 10), sticky="e")
            header_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            header_entry.grid(row=4, column=1, padx=10, pady=(10, 10), sticky="w")
            cookie_label = ctk.CTkLabel(self.content_frame, text="Session Cookies:", font=("arial", 16, "bold"))
            cookie_label.grid(row=5, column=0, padx=10, pady=(10, 10), sticky="e")
            cookie_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            cookie_entry.grid(row=5, column=1, padx=10, pady=(10, 10), sticky="w")
            attack_label = ctk.CTkLabel(self.content_frame, text="Attack Type:", font=("arial", 16, "bold"))
            attack_label.grid(row=6, column=0, padx=10, pady=(10, 10), sticky="e")
            attack_dropdown = ctk.CTkOptionMenu(self.content_frame, values=["file_read", "ssrf", "blind_oob", "xml_bomb"])
            attack_dropdown.grid(row=6, column=1, padx=10, pady=(10, 10), sticky="w")
            target_label = ctk.CTkLabel(self.content_frame, text="Target:", font=("arial", 16, "bold"))
            target_label.grid(row=7, column=0, padx=10, pady=(10, 10), sticky="e")
            target_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            target_entry.grid(row=7, column=1, padx=10, pady=(10, 10), sticky="w")
            encoding_label = ctk.CTkLabel(self.content_frame, text="Encoding:", font=("arial", 16, "bold"))
            encoding_label.grid(row=8, column=0, padx=10, pady=(10, 10), sticky="e")
            encoding_dropdown = ctk.CTkOptionMenu(self.content_frame, values=["base64", "hex"])
            encoding_dropdown.grid(row=8, column=1, padx=10, pady=(10, 10), sticky="w")
            submit_button = ctk.CTkButton(self.content_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
            submit_button.grid(row=9, columnspan=2, pady=15)
            log_frame = ctk.CTkScrollableFrame(self.content_frame, width=500)
            log_frame.grid(row=10,columnspan=2,pady=(20,5))
        ...
        if n.lower() in ["xss scan"]:
            ...
            user_agent_label = ctk.CTkLabel(self.content_frame, text="User-Agent:", font=("arial", 16, "bold"))
            user_agent_label.grid(row=4, column=0, padx=10, pady=(10, 10), sticky="e")
            user_agent_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            user_agent_entry.grid(row=4, column=1, padx=10, pady=(10, 10), sticky="w")
            payloads_label = ctk.CTkLabel(self.content_frame, text="Payload File:", font=("arial", 16, "bold"))
            payloads_label.grid(row=5, column=0, padx=10, pady=(10, 10), sticky="e")
            payloads_entry = ctk.CTkEntry(self.content_frame, width=300, font=("arial", 16))
            payloads_entry.grid(row=5, column=1, padx=10, pady=(10, 10), sticky="w")
            threads_label = ctk.CTkLabel(self.content_frame, text="Threads:", font=("arial", 16, "bold"))
            threads_label.grid(row=6, column=0, padx=10, pady=(10, 10), sticky="e")
            threads_entry = ctk.CTkEntry(self.content_frame, width=100, font=("arial", 16))
            threads_entry.grid(row=6, column=1, padx=10, pady=(10, 10), sticky="w")
    ...
    def log_update_callback(self,message):
        if self.log_label: 
            self.log_label.configure(text=self.log_label.cget("text") + "\n"+message,font=("arial",14))
    ...
    def scan(self,url,port,tool,wordlists,useragent,cookies,threads):
        ...
        if tool=="banner_grabber": 
            ...
            recon_process = ReconProcess(url, port, self.log_update_callback,tool)
            recon_process.BannerGrabber()
        if tool == "dir_enum": 
            recon_process = ReconProcess(url,wordlists,useragent,cookies,threads)
