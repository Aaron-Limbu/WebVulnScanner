from process.recon_process import ReconProcess
...
class Dash(ctk.CTk): 
    ...
    def form(self,n):       
        if n.lower() in ["banner grabber"]:
            ...
            def log_update_callback(message): 
                log_label.configure(text=log_label.cget("text")+message)
                log_label.update_idletasks()
            
            recon_process = ReconProcess(url,ports,log_update_callback)
        ...
        if n.lower() in ["shodan recon"]: 
            ...
            ip_label = ctk.CTkLabel(self.content_frame, text="Target IP Address:", font=("arial", 16, "bold"))
            ip_label.grid(row=2, column=0, padx=10, pady=(10, 10), sticky="e")
            ip_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ip_entry.grid(row=2, column=1, padx=10, pady=(10, 10), sticky="w")
            domain_label = ctk.CTkLabel(self.content_frame, text="Target Domain:", font=("arial", 16, "bold"))
            domain_label.grid(row=3, column=0, padx=10, pady=(10, 10), sticky="e")
            domain_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            domain_entry.grid(row=3, column=1, padx=10, pady=(10, 10), sticky="w")
            query_label = ctk.CTkLabel(self.content_frame, text="Shodan Query:", font=("arial", 16, "bold"))
            query_label.grid(row=4, column=0, padx=10, pady=(10, 10), sticky="e")
            query_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            query_entry.grid(row=4, column=1, padx=10, pady=(10, 10), sticky="w")
            device_query_label = ctk.CTkLabel(self.content_frame, text="Device Query:", font=("arial", 16, "bold"))
            device_query_label.grid(row=5, column=0, padx=10, pady=(10, 10), sticky="e")
            device_query_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            device_query_entry.grid(row=5, column=1, padx=10, pady=(10, 10), sticky="w")
            submit_button = ctk.CTkButton(self.content_frame,text="Start Scan",font=("arial",20),width=400, height=40)  #command=self.start_banner_grabber)
        ...
        if n.lower() in ["csrf scanning"]:
            ...
            domain_entry = ctk.CTkEntry(self.content_frame,width=250,font=("arial",18))
            domain_entry.grid(row=2,column=1,padx=10,pady=(40,20),sticky="w")
            cookie_label = ctk.CTkLabel(self.content_frame,text="Enter Cookie : ",font=("arial",18))
            cookie_label.grid(row=3,column=0,padx=10,pady=(40,20),sticky="e")
            cookie_entry = ctk.CTkEntry(self.content_frame,width=250,font=("arial",18))
        ...
        if n.lower() in ["idor scan"]:
            ...
            url_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            param_label.grid(row=3, column=0, padx=10, pady=(10, 10), sticky="e")
            param_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            start_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            end_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            header_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            cookie_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
        ...
        if n.lower() in ["lfi scan"]:
            ...
            cookies_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            headers_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            threads_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
        ...
        if n.lower() in ["nmap scan"]:
            ...
            ports_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            args_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            script_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
        ...
        if n.lower() in ["sql injection(error based)"]:
            ...
            user_agent_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
        ...
        if n.lower() in ["ssrf scan"]:
            ...
            delay_label = ctk.CTkLabel(self.content_frame, text="Delay (seconds):", font=("arial", 16, "bold"))
            delay_label.grid(row=7, column=0, padx=10, pady=(10, 10), sticky="e")
            delay_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
            ...
            wordlist_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
        ...
        if n.lower() in ["xee scan"]:
            ...
            target_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
        ...
        if n.lower() in ["xss scan"]:
            ...
            payloads_entry = ctk.CTkEntry(self.content_frame, width=250, font=("arial", 16))
